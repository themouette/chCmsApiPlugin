<?php
/**
 * This file declare the PluginChCmsApiArrayFormatter class.
 *
...
/**
 * the base formatter for arrays.
 * To declare a formatter, just extend this class and setDefaultFormatFields
 * in the initialize method.
 */
class PluginChCmsApiArrayFormatter extends BasechCmsApiFormatter implements ArrayAccess
{
  /**
  ...
  protected function getFieldFormatter($output_name, $formatter = null)
  {
    ...
    if (!$formatter->getOption('extract_method', false))
    {
      $formatter->setOption('extract_method', array($this, 'extractProperty'));
    }
...
} // END OF PluginChCmsApiArrayFormatter