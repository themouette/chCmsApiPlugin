<?php
/**
 * This file declare the PluginChCmsApiPagerFormatter class.
 *
 ...
 * pager formatter
 */
class PluginChCmsApiPagerFormatter extends chCmsApiObjectFormatter
{
  /**
   * constructor
   *
...
} // END OF PluginChCmsApiPagerFormatter